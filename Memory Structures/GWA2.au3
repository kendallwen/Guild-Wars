...
Func Initialize($aGW, $bChangeTitle = True, $aUseStringLog = False, $aUseEventSystem = True)
	...
	DllStructSetData($mSendChat, 2, 0x5E) ; Checked
...
Func DropItem($aItem, $aAmount = 0) ; Checked
...
Func MoveItem($aItem, $aBag, $aSlot) ; Checked
...
Func DropGold($aAmount = 0) ; Checked
	Local $lAmount
...
Func ChangeGold($aCharacter, $aStorage) ; Checked
...
Func CommandAll($aX, $aY) ; Checked
	Return SendPacket(0x10, 0x14, FloatToInt($aX), FloatToInt($aY), 0)
EndFunc   ;==>CommandAll

;~ Description: Lock a hero onto a target.
Func LockHeroTarget($aHeroNumber, $aAgentID = 0) ;$aAgentID=0 Cancels Lock  ; Checked
...
Func SetHeroAggression($aHeroNumber, $aAggression) ;0=Fight, 1=Guard, 2=Avoid ; Checked
	Local $lHeroID = GetHeroID($aHeroNumber)
...
Func ChangeHeroSkillSlotState($aHeroNumber, $aSkillSlot) ; Checked
...
Func GoSignpost($aAgent) ; Checked
	Local $lAgentID
...
Func Attack($aAgent, $aCallTarget = False) ; Checked
	Local $lAgentID
...
;~ Description: Internal use for map travel.
Func MoveMap($aMapID, $aRegion, $aDistrict, $aLanguage) ; Checked
...
Func CallTarget($aTarget) ; Checked
	Local $lTargetID
...
Func DonateFaction($aFaction) ; Checked
...
Func LoadSkillBar($aSkill1 = 0, $aSkill2 = 0, $aSkill3 = 0, $aSkill4 = 0, $aSkill5 = 0, $aSkill6 = 0, $aSkill7 = 0, $aSkill8 = 0, $aHeroNumber = 0) ; Checked
...
Func ChangeSecondProfession($aProfession, $aHeroNumber = 0) ; Checked
...
Func CreateCommands()
	...
	_('CommandBuyItem:')
	_('add eax,4') ; eax début pointer structure / 4 premiers octet adress, après paramètres
	_('push eax')
	_('add eax,4')
	_('push eax')
	_('push 1')
